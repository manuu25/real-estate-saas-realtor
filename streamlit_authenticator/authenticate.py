...
class Authenticate:
    ...
    def __init__(self, cookie_name: str, key: str, cookie_expiry_days: int=30):
        ...
        # Mailchimp es opcional (solo para la lista de correo / registro). Si no hay clave, no rompe el login.
        try:
            self.mailchimp_client = MailChimp(mc_api=os.environ.get('MAILCHIMP_API_KEY', 'placeholder-us1'))
        except Exception:
